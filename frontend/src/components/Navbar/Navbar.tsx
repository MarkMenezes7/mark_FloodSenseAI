        ...
        <div className="navbar-inner">
          ...
          <NavLink to="/" className="navbar-logo" id="navbar-logo">
            ...
            <div className="logo-text">
              <span className="logo-name">FloodSense</span>
          ...
          <div className="navbar-center">
            ...
            <a
              ...
              className="btn btn-whatsapp navbar-wa-btn"
          ...
          <div className="navbar-right">
            <div className="navbar-dev-info">
              ...
              <p className="dev-contact">📧 markmenezes198@gmail.com</p>
              <p className="dev-contact">📞 +91 8452857820</p>
            </div>
