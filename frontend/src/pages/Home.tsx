      ...
      <section className="hero-section">
        <div className="container hero-container">
          <div className="hero-content animate-fadeInUp">
            ...
            <p className="hero-note hero-note-desktop">✅ No sign-up · ✅ Completely free · ✅ Works on any device</p>
          </div>
          <div className="hero-image-wrap animate-float">
            <img src="/hero.png" alt="FloodSenseAI flood risk monitoring" className="hero-img" />
          </div>
          {/* Mobile-only CTA — appears below image */}
          <div className="hero-mobile-cta">
            <div className="hero-actions">
              <Link to="/check-risk" className="btn btn-primary hero-btn">
                🔍 Check Flood Risk Now
              </Link>
              <a
                href="https://wa.me/14155238886?text=hi"
