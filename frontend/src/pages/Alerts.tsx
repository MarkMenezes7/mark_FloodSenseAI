            ...
            {status === 'success' ? (
              <div className="success-state">
                ...
                <div className="activation-box">
                  <p><strong>One last step — activate the bot:</strong></p>
                  <p>Open WhatsApp and send <code>hi</code> to this number:</p>
                  <div className="bot-number">{BOT_NUMBER}</div>
                  <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp wa-activate-btn" id="wa-activate-btn">
          ...
          <div className="alerts-right">
            ...
            <div className="steps-list">
              {[
                ...
                { n: '2', title: 'Activate the bot', desc: `Send "hi" to ${BOT_NUMBER} on WhatsApp to activate your subscription.` },
