        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ margin: '0 0 10px', color: '#94a3b8', fontSize: '0.88rem', lineHeight: 1.5 }}>
              This bot runs on <strong style={{color:'#e2e8f0'}}>Twilio Sandbox</strong>. Before any message works, you
              must send exactly this phrase to <strong style={{color:'#e2e8f0'}}>{BOT_NUMBER}</strong>:
            </p>
            <div style={{
              background: 'rgba(0,0,0,0.4)', border: '1px solid #333', borderRadius: 8,
              padding: '8px 16px', fontFamily: 'monospace', fontSize: '1.1rem',
              color: '#25D366', letterSpacing: 1, marginBottom: 12, display: 'inline-block'
            }}>
              join young-except
            </div>
            <br />
        ...
        <div className="alerts-layout">
            ...
            {status === 'success' ? (
              <div className="success-state">
                ...
                <div className="activation-box">
                  ...
                  <p style={{fontSize:'0.85rem',color:'#94a3b8',marginBottom:8}}>Send exactly this to <strong style={{color:'#e2e8f0'}}>{BOT_NUMBER}</strong>:</p>
                  <div style={{fontFamily:'monospace',fontSize:'1.1rem',color:'#25D366',background:'rgba(0,0,0,0.4)',padding:'6px 14px',borderRadius:7,display:'inline-block',marginBottom:12}}>join young-except</div>
                  <br />
          ...
          <div className="alerts-right">
            ...
            <div className="card wa-quick-card">
              ...
              <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp wa-full-btn" id="wa-quick-btn">
